...
const trainings: Training[] = [
  {
    ...
    imageSrc: '/news/rasuwa-floods.jpg',
    title: 'Standing With Nepal After the Rasuwa Floods',
    date: '26 August 2026',
    description: 'The floods that swept through Rasuwa, Nuwakot, Dhading, Gorkha and Tanahun on 26 August 2026 have caused profound loss and disruption across affected communities. At the Nepal Center for Philanthropy and Development (NCPD), our thoughts are with the families who have lost loved ones, those still waiting for news of missing family members, and all those whose homes, livelihoods and communities have been severely affected.',
    ctaLabel: 'Read More',
  },
  {
          ...
          >
            ...
            <div className="lg:w-180 flex flex-col justify-center gap-4">
              ...
              >
                ...
                <span className="relative z-10">{training.ctaLabel ?? 'View More'}</span>
              </a>
            </div>
          </div>
        ))}
